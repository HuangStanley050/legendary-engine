...
/*!***************************************************************!*\
  !*** external "products@http://loalhost:8081/remoteEntry.js" ***!
  \***************************************************************/
/*! dynamic exports */
...
"use strict";
eval("var error = new Error();\nmodule.exports = new Promise((resolve, reject) => {\n\tif(typeof products !== \"undefined\") return resolve();\n\t__webpack_require__.l(\"http://loalhost:8081/remoteEntry.js\", (event) => {\n\t\tif(typeof products !== \"undefined\") return resolve();\n\t\tvar errorType = event && (event.type === 'load' ? 'missing' : event.type);\n\t\tvar realSrc = event && event.target && event.target.src;\n\t\terror.message = 'Loading script failed.\\n(' + errorType + ': ' + realSrc + ')';\n\t\terror.name = 'ScriptExternalLoadError';\n\t\terror.type = errorType;\n\t\terror.request = realSrc;\n\t\treject(error);\n\t}, \"products\");\n}).then(() => products);\n\n//# sourceURL=webpack://container/external_%22products@http://loalhost:8081/remoteEntry.js%22?");
